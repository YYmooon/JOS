...
exit(void)
{
  ...
  800097:	83 ec 18             	sub    $0x18,%esp
	close_all();
  80009a:	e8 1f 06 00 00       	call   8006be <close_all>
	sys_env_destroy(0);
  80009f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000a6:	e8 64 00 00 00       	call   80010f <sys_env_destroy>
}
  8000ab:	c9                   	leave  
  8000ac:	c3                   	ret    
...
sys_env_destroy(envid_t envid)
{
  ...
  800142:	00 
  800143:	c7 44 24 08 aa 21 80 	movl   $0x8021aa,0x8(%esp)
  80014a:	00 
  80014b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800152:	00 
  800153:	c7 04 24 c7 21 80 00 	movl   $0x8021c7,(%esp)
  80015a:	e8 31 11 00 00       	call   801290 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800201:	00 
  800202:	c7 44 24 08 aa 21 80 	movl   $0x8021aa,0x8(%esp)
  800209:	00 
  80020a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800211:	00 
  800212:	c7 04 24 c7 21 80 00 	movl   $0x8021c7,(%esp)
  800219:	e8 72 10 00 00       	call   801290 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80025f:	00 
  800260:	c7 44 24 08 aa 21 80 	movl   $0x8021aa,0x8(%esp)
  800267:	00 
  800268:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80026f:	00 
  800270:	c7 04 24 c7 21 80 00 	movl   $0x8021c7,(%esp)
  800277:	e8 14 10 00 00       	call   801290 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002bd:	00 
  8002be:	c7 44 24 08 aa 21 80 	movl   $0x8021aa,0x8(%esp)
  8002c5:	00 
  8002c6:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002cd:	00 
  8002ce:	c7 04 24 c7 21 80 00 	movl   $0x8021c7,(%esp)
  8002d5:	e8 b6 0f 00 00       	call   801290 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80031b:	00 
  80031c:	c7 44 24 08 aa 21 80 	movl   $0x8021aa,0x8(%esp)
  800323:	00 
  800324:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80032b:	00 
  80032c:	c7 04 24 c7 21 80 00 	movl   $0x8021c7,(%esp)
  800333:	e8 58 0f 00 00       	call   801290 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800379:	00 
  80037a:	c7 44 24 08 aa 21 80 	movl   $0x8021aa,0x8(%esp)
  800381:	00 
  800382:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800389:	00 
  80038a:	c7 04 24 c7 21 80 00 	movl   $0x8021c7,(%esp)
  800391:	e8 fa 0e 00 00       	call   801290 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8003d7:	00 
  8003d8:	c7 44 24 08 aa 21 80 	movl   $0x8021aa,0x8(%esp)
  8003df:	00 
  8003e0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003e7:	00 
  8003e8:	c7 04 24 c7 21 80 00 	movl   $0x8021c7,(%esp)
  8003ef:	e8 9c 0e 00 00       	call   801290 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800468:	00 
  800469:	c7 44 24 08 aa 21 80 	movl   $0x8021aa,0x8(%esp)
  800470:	00 
  800471:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800478:	00 
  800479:	c7 04 24 c7 21 80 00 	movl   $0x8021c7,(%esp)
  800480:	e8 0b 0e 00 00       	call   801290 <_panic>
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8005c3:	8b 14 85 54 22 80 00 	mov    0x802254(,%eax,4),%edx
  ...
  8005de:	c7 04 24 d8 21 80 00 	movl   $0x8021d8,(%esp)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800679:	e8 0b fc ff ff       	call   800289 <sys_page_unmap>
	return r;
}
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800782:	e8 a4 fa ff ff       	call   80022b <sys_page_map>
  ...
  8007bd:	e8 69 fa ff ff       	call   80022b <sys_page_map>
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800851:	c7 04 24 19 22 80 00 	movl   $0x802219,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  80092c:	c7 04 24 35 22 80 00 	movl   $0x802235,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8009e3:	c7 04 24 f8 21 80 00 	movl   $0x8021f8,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800bfd:	c7 44 24 0c 64 22 80 	movl   $0x802264,0xc(%esp)
  800c04:	00 
  800c05:	c7 44 24 08 6b 22 80 	movl   $0x80226b,0x8(%esp)
  800c0c:	00 
  800c0d:	c7 44 24 04 7a 00 00 	movl   $0x7a,0x4(%esp)
  800c14:	00 
  800c15:	c7 04 24 80 22 80 00 	movl   $0x802280,(%esp)
  800c1c:	e8 6f 06 00 00       	call   801290 <_panic>
	assert(r <= PGSIZE);
  800c21:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800c26:	7e 24                	jle    800c4c <devfile_read+0x84>
  800c28:	c7 44 24 0c 8b 22 80 	movl   $0x80228b,0xc(%esp)
  800c2f:	00 
  800c30:	c7 44 24 08 6b 22 80 	movl   $0x80226b,0x8(%esp)
  800c37:	00 
  800c38:	c7 44 24 04 7b 00 00 	movl   $0x7b,0x4(%esp)
  800c3f:	00 
  800c40:	c7 04 24 80 22 80 00 	movl   $0x802280,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800d1c:	c7 44 24 04 97 22 80 	movl   $0x802297,0x4(%esp)
  800d23:	00 
...
devpipe_close(struct Fd *fd)
{
  ...
  800d6f:	e8 15 f5 ff ff       	call   800289 <sys_page_unmap>
  ...
  800d87:	e8 fd f4 ff ff       	call   800289 <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800dee:	c7 04 24 9e 22 80 00 	movl   $0x80229e,(%esp)
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  800e2a:	75 53                	jne    800e7f <devpipe_write+0x83>
			...
			sys_yield();
  800e2c:	e8 6b f3 ff ff       	call   80019c <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  800ec7:	75 49                	jne    800f12 <devpipe_read+0x86>
			...
			sys_yield();
  800ec9:	e8 ce f2 ff ff       	call   80019c <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  800f61:	e8 66 f2 ff ff       	call   8001cc <sys_page_alloc>
  ...
  800f9b:	e8 2c f2 ff ff       	call   8001cc <sys_page_alloc>
  ...
  800fca:	e8 fd f1 ff ff       	call   8001cc <sys_page_alloc>
  ...
  801003:	e8 23 f2 ff ff       	call   80022b <sys_page_map>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8010f0:	c7 44 24 04 b6 22 80 	movl   $0x8022b6,0x4(%esp)
  8010f7:	00 
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801156:	e8 55 ef ff ff       	call   8000b0 <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801182:	eb 31                	jmp    8011b5 <devcons_read+0x44>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801184:	e8 13 f0 ff ff       	call   80019c <sys_yield>
	int c;
  ...
  801190:	e8 4a ef ff ff       	call   8000df <sys_cgetc>
...
cputchar(int ch)
{
  ...
  8011d1:	e8 da ee ff ff       	call   8000b0 <sys_cputs>
}
  8011d6:	c9                   	leave  
  8011d7:	c3                   	ret    
...
opencons(void)
{
  ...
  801268:	e8 5f ef ff ff       	call   8001cc <sys_page_alloc>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8012a1:	e8 c6 ee ff ff       	call   80016c <sys_getenvid>
  ...
  8012bc:	c7 04 24 c4 22 80 00 	movl   $0x8022c4,(%esp)
  ...
  8012d2:	e8 53 00 00 00       	call   80132a <vcprintf>
	cprintf("\n");
  8012d7:	c7 04 24 af 22 80 00 	movl   $0x8022af,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  801315:	e8 96 ed ff ff       	call   8000b0 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80137e:	e8 2d ed ff ff       	call   8000b0 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801476:	0f be 80 e7 22 80 00 	movsbl 0x8022e7(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801663:	c7 44 24 08 ff 22 80 	movl   $0x8022ff,0x8(%esp)
  80166a:	00 
  ...
  801686:	c7 44 24 08 7d 22 80 	movl   $0x80227d,0x8(%esp)
  80168d:	00 
  ...
  8016bb:	ba f8 22 80 00       	mov    $0x8022f8,%edx
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801dae:	e8 82 e6 ff ff       	call   800435 <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801e28:	e8 d4 e5 ff ff       	call   800401 <sys_ipc_try_send>
    	if(err == -E_IPC_NOT_RECV){
  801e2d:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801e30:	75 07                	jne    801e39 <ipc_send+0x57>
           sys_yield();
  801e32:	e8 65 e3 ff ff       	call   80019c <sys_yield>
          return ;
        }
		else{
			panic("ipc_send\n");
