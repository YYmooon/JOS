...
exit(void)
{
  ...
  8000a3:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000a6:	e8 13 06 00 00       	call   8006be <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  80014e:	00 
  80014f:	c7 44 24 08 aa 21 80 	movl   $0x8021aa,0x8(%esp)
  800156:	00 
  800157:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80015e:	00 
  80015f:	c7 04 24 c7 21 80 00 	movl   $0x8021c7,(%esp)
  800166:	e8 25 11 00 00       	call   801290 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80020d:	00 
  80020e:	c7 44 24 08 aa 21 80 	movl   $0x8021aa,0x8(%esp)
  800215:	00 
  800216:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80021d:	00 
  80021e:	c7 04 24 c7 21 80 00 	movl   $0x8021c7,(%esp)
  800225:	e8 66 10 00 00       	call   801290 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80026b:	00 
  80026c:	c7 44 24 08 aa 21 80 	movl   $0x8021aa,0x8(%esp)
  800273:	00 
  800274:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80027b:	00 
  80027c:	c7 04 24 c7 21 80 00 	movl   $0x8021c7,(%esp)
  800283:	e8 08 10 00 00       	call   801290 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002c9:	00 
  8002ca:	c7 44 24 08 aa 21 80 	movl   $0x8021aa,0x8(%esp)
  8002d1:	00 
  8002d2:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002d9:	00 
  8002da:	c7 04 24 c7 21 80 00 	movl   $0x8021c7,(%esp)
  8002e1:	e8 aa 0f 00 00       	call   801290 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800327:	00 
  800328:	c7 44 24 08 aa 21 80 	movl   $0x8021aa,0x8(%esp)
  80032f:	00 
  800330:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800337:	00 
  800338:	c7 04 24 c7 21 80 00 	movl   $0x8021c7,(%esp)
  80033f:	e8 4c 0f 00 00       	call   801290 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  80039d:	e8 ee 0e 00 00       	call   801290 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8003e3:	00 
  8003e4:	c7 44 24 08 aa 21 80 	movl   $0x8021aa,0x8(%esp)
  8003eb:	00 
  8003ec:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003f3:	00 
  8003f4:	c7 04 24 c7 21 80 00 	movl   $0x8021c7,(%esp)
  8003fb:	e8 90 0e 00 00       	call   801290 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800474:	00 
  800475:	c7 44 24 08 aa 21 80 	movl   $0x8021aa,0x8(%esp)
  80047c:	00 
  80047d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800484:	00 
  800485:	c7 04 24 c7 21 80 00 	movl   $0x8021c7,(%esp)
  80048c:	e8 ff 0d 00 00       	call   801290 <_panic>
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800679:	e8 17 fc ff ff       	call   800295 <sys_page_unmap>
	return r;
}
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800782:	e8 b0 fa ff ff       	call   800237 <sys_page_map>
  ...
  8007bd:	e8 75 fa ff ff       	call   800237 <sys_page_map>
...
devpipe_close(struct Fd *fd)
{
  ...
  800d6f:	e8 21 f5 ff ff       	call   800295 <sys_page_unmap>
  ...
  800d87:	e8 09 f5 ff ff       	call   800295 <sys_page_unmap>
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  800e2a:	75 53                	jne    800e7f <devpipe_write+0x83>
			...
			sys_yield();
  800e2c:	e8 77 f3 ff ff       	call   8001a8 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  800ec7:	75 49                	jne    800f12 <devpipe_read+0x86>
			...
			sys_yield();
  800ec9:	e8 da f2 ff ff       	call   8001a8 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  800f61:	e8 72 f2 ff ff       	call   8001d8 <sys_page_alloc>
  ...
  800f9b:	e8 38 f2 ff ff       	call   8001d8 <sys_page_alloc>
  ...
  800fca:	e8 09 f2 ff ff       	call   8001d8 <sys_page_alloc>
  ...
  801003:	e8 2f f2 ff ff       	call   800237 <sys_page_map>
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801156:	e8 61 ef ff ff       	call   8000bc <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801182:	eb 31                	jmp    8011b5 <devcons_read+0x44>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801184:	e8 1f f0 ff ff       	call   8001a8 <sys_yield>
	int c;
  ...
  801190:	e8 56 ef ff ff       	call   8000eb <sys_cgetc>
...
cputchar(int ch)
{
  ...
  8011d1:	e8 e6 ee ff ff       	call   8000bc <sys_cputs>
}
  8011d6:	c9                   	leave  
  8011d7:	c3                   	ret    
...
opencons(void)
{
  ...
  801268:	e8 6b ef ff ff       	call   8001d8 <sys_page_alloc>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8012a1:	e8 d2 ee ff ff       	call   800178 <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  801315:	e8 a2 ed ff ff       	call   8000bc <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80137e:	e8 39 ed ff ff       	call   8000bc <sys_cputs>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801dae:	e8 8e e6 ff ff       	call   800441 <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801e28:	e8 e0 e5 ff ff       	call   80040d <sys_ipc_try_send>
    	if(err == -E_IPC_NOT_RECV){
  801e2d:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801e30:	75 07                	jne    801e39 <ipc_send+0x57>
           sys_yield();
  801e32:	e8 71 e3 ff ff       	call   8001a8 <sys_yield>
          return ;
        }
		else{
			panic("ipc_send\n");
