	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800246:	0f be 80 e8 21 80 00 	movsbl 0x8021e8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80036e:	ff 24 85 20 23 80 00 	jmp    *0x802320(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800456:	c7 44 24 08 b1 25 80 	movl   $0x8025b1,0x8(%esp)
  80045d:	00 
  ...
  80048b:	ba f9 21 80 00       	mov    $0x8021f9,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800bf2:	00 
  800bf3:	c7 44 24 08 df 24 80 	movl   $0x8024df,0x8(%esp)
  800bfa:	00 
  800bfb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c02:	00 
  800c03:	c7 04 24 fc 24 80 00 	movl   $0x8024fc,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800cb1:	00 
  800cb2:	c7 44 24 08 df 24 80 	movl   $0x8024df,0x8(%esp)
  800cb9:	00 
  800cba:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cc1:	00 
  800cc2:	c7 04 24 fc 24 80 00 	movl   $0x8024fc,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d0f:	00 
  800d10:	c7 44 24 08 df 24 80 	movl   $0x8024df,0x8(%esp)
  800d17:	00 
  800d18:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d1f:	00 
  800d20:	c7 04 24 fc 24 80 00 	movl   $0x8024fc,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d6d:	00 
  800d6e:	c7 44 24 08 df 24 80 	movl   $0x8024df,0x8(%esp)
  800d75:	00 
  800d76:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d7d:	00 
  800d7e:	c7 04 24 fc 24 80 00 	movl   $0x8024fc,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800dcb:	00 
  800dcc:	c7 44 24 08 df 24 80 	movl   $0x8024df,0x8(%esp)
  800dd3:	00 
  800dd4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ddb:	00 
  800ddc:	c7 04 24 fc 24 80 00 	movl   $0x8024fc,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800e29:	00 
  800e2a:	c7 44 24 08 df 24 80 	movl   $0x8024df,0x8(%esp)
  800e31:	00 
  800e32:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e39:	00 
  800e3a:	c7 04 24 fc 24 80 00 	movl   $0x8024fc,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e87:	00 
  800e88:	c7 44 24 08 df 24 80 	movl   $0x8024df,0x8(%esp)
  800e8f:	00 
  800e90:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e97:	00 
  800e98:	c7 04 24 fc 24 80 00 	movl   $0x8024fc,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800f18:	00 
  800f19:	c7 44 24 08 df 24 80 	movl   $0x8024df,0x8(%esp)
  800f20:	00 
  800f21:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f28:	00 
  800f29:	c7 04 24 fc 24 80 00 	movl   $0x8024fc,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  801073:	8b 14 85 88 25 80 00 	mov    0x802588(,%eax,4),%edx
  ...
  80108e:	c7 04 24 0c 25 80 00 	movl   $0x80250c,(%esp)
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801301:	c7 04 24 4d 25 80 00 	movl   $0x80254d,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8013dc:	c7 04 24 69 25 80 00 	movl   $0x802569,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801493:	c7 04 24 2c 25 80 00 	movl   $0x80252c,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8016ad:	c7 44 24 0c 98 25 80 	movl   $0x802598,0xc(%esp)
  8016b4:	00 
  8016b5:	c7 44 24 08 9f 25 80 	movl   $0x80259f,0x8(%esp)
  8016bc:	00 
  8016bd:	c7 44 24 04 7a 00 00 	movl   $0x7a,0x4(%esp)
  8016c4:	00 
  8016c5:	c7 04 24 b4 25 80 00 	movl   $0x8025b4,(%esp)
  8016cc:	e8 6f 06 00 00       	call   801d40 <_panic>
	assert(r <= PGSIZE);
  8016d1:	3d 00 10 00 00       	cmp    $0x1000,%eax
  8016d6:	7e 24                	jle    8016fc <devfile_read+0x84>
  8016d8:	c7 44 24 0c bf 25 80 	movl   $0x8025bf,0xc(%esp)
  8016df:	00 
  8016e0:	c7 44 24 08 9f 25 80 	movl   $0x80259f,0x8(%esp)
  8016e7:	00 
  8016e8:	c7 44 24 04 7b 00 00 	movl   $0x7b,0x4(%esp)
  8016ef:	00 
  8016f0:	c7 04 24 b4 25 80 00 	movl   $0x8025b4,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8017cc:	c7 44 24 04 cb 25 80 	movl   $0x8025cb,0x4(%esp)
  8017d3:	00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  80189e:	c7 04 24 d2 25 80 00 	movl   $0x8025d2,(%esp)
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801ba0:	c7 44 24 04 ea 25 80 	movl   $0x8025ea,0x4(%esp)
  801ba7:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801d6c:	c7 04 24 f8 25 80 00 	movl   $0x8025f8,(%esp)
  ...
  801d82:	e8 7b e3 ff ff       	call   800102 <vcprintf>
	cprintf("\n");
  801d87:	c7 04 24 dc 21 80 00 	movl   $0x8021dc,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801e50:	74 1c                	je     801e6e <ipc_send+0x7c>
          return ;
			...
			panic("ipc_send\n");
  801e52:	c7 44 24 08 1c 26 80 	movl   $0x80261c,0x8(%esp)
  801e59:	00 
  801e5a:	c7 44 24 04 52 00 00 	movl   $0x52,0x4(%esp)
  801e61:	00 
  801e62:	c7 04 24 26 26 80 00 	movl   $0x802626,(%esp)
