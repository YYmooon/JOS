...
exit(void)
{
  ...
  80008f:	83 ec 18             	sub    $0x18,%esp
	close_all();
  800092:	e8 17 06 00 00       	call   8006ae <close_all>
	sys_env_destroy(0);
  800097:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80009e:	e8 64 00 00 00       	call   800107 <sys_env_destroy>
}
  8000a3:	c9                   	leave  
  8000a4:	c3                   	ret    
...
sys_env_destroy(envid_t envid)
{
  ...
  80013a:	00 
  80013b:	c7 44 24 08 aa 21 80 	movl   $0x8021aa,0x8(%esp)
  800142:	00 
  800143:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80014a:	00 
  80014b:	c7 04 24 c7 21 80 00 	movl   $0x8021c7,(%esp)
  800152:	e8 29 11 00 00       	call   801280 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001f9:	00 
  8001fa:	c7 44 24 08 aa 21 80 	movl   $0x8021aa,0x8(%esp)
  800201:	00 
  800202:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800209:	00 
  80020a:	c7 04 24 c7 21 80 00 	movl   $0x8021c7,(%esp)
  800211:	e8 6a 10 00 00       	call   801280 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800257:	00 
  800258:	c7 44 24 08 aa 21 80 	movl   $0x8021aa,0x8(%esp)
  80025f:	00 
  800260:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800267:	00 
  800268:	c7 04 24 c7 21 80 00 	movl   $0x8021c7,(%esp)
  80026f:	e8 0c 10 00 00       	call   801280 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002b5:	00 
  8002b6:	c7 44 24 08 aa 21 80 	movl   $0x8021aa,0x8(%esp)
  8002bd:	00 
  8002be:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002c5:	00 
  8002c6:	c7 04 24 c7 21 80 00 	movl   $0x8021c7,(%esp)
  8002cd:	e8 ae 0f 00 00       	call   801280 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800313:	00 
  800314:	c7 44 24 08 aa 21 80 	movl   $0x8021aa,0x8(%esp)
  80031b:	00 
  80031c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800323:	00 
  800324:	c7 04 24 c7 21 80 00 	movl   $0x8021c7,(%esp)
  80032b:	e8 50 0f 00 00       	call   801280 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800371:	00 
  800372:	c7 44 24 08 aa 21 80 	movl   $0x8021aa,0x8(%esp)
  800379:	00 
  80037a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800381:	00 
  800382:	c7 04 24 c7 21 80 00 	movl   $0x8021c7,(%esp)
  800389:	e8 f2 0e 00 00       	call   801280 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8003cf:	00 
  8003d0:	c7 44 24 08 aa 21 80 	movl   $0x8021aa,0x8(%esp)
  8003d7:	00 
  8003d8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003df:	00 
  8003e0:	c7 04 24 c7 21 80 00 	movl   $0x8021c7,(%esp)
  8003e7:	e8 94 0e 00 00       	call   801280 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800460:	00 
  800461:	c7 44 24 08 aa 21 80 	movl   $0x8021aa,0x8(%esp)
  800468:	00 
  800469:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800470:	00 
  800471:	c7 04 24 c7 21 80 00 	movl   $0x8021c7,(%esp)
  800478:	e8 03 0e 00 00       	call   801280 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800488:	5d                   	pop    %ebp
  800489:	c3                   	ret    
  80048a:	00 00                	add    %al,(%eax)
  80048c:	00 00                	add    %al,(%eax)
	...
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800669:	e8 13 fc ff ff       	call   800281 <sys_page_unmap>
	return r;
}
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800772:	e8 ac fa ff ff       	call   800223 <sys_page_map>
  ...
  8007ad:	e8 71 fa ff ff       	call   800223 <sys_page_map>
...
devpipe_close(struct Fd *fd)
{
  ...
  800d5f:	e8 1d f5 ff ff       	call   800281 <sys_page_unmap>
  ...
  800d77:	e8 05 f5 ff ff       	call   800281 <sys_page_unmap>
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  800e1a:	75 53                	jne    800e6f <devpipe_write+0x83>
			...
			sys_yield();
  800e1c:	e8 73 f3 ff ff       	call   800194 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  800eb7:	75 49                	jne    800f02 <devpipe_read+0x86>
			...
			sys_yield();
  800eb9:	e8 d6 f2 ff ff       	call   800194 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  800f51:	e8 6e f2 ff ff       	call   8001c4 <sys_page_alloc>
  ...
  800f8b:	e8 34 f2 ff ff       	call   8001c4 <sys_page_alloc>
  ...
  800fba:	e8 05 f2 ff ff       	call   8001c4 <sys_page_alloc>
  ...
  800ff3:	e8 2b f2 ff ff       	call   800223 <sys_page_map>
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801146:	e8 5d ef ff ff       	call   8000a8 <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801172:	eb 31                	jmp    8011a5 <devcons_read+0x44>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801174:	e8 1b f0 ff ff       	call   800194 <sys_yield>
	int c;
  ...
  801180:	e8 52 ef ff ff       	call   8000d7 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  8011c1:	e8 e2 ee ff ff       	call   8000a8 <sys_cputs>
}
  8011c6:	c9                   	leave  
  8011c7:	c3                   	ret    
...
opencons(void)
{
  ...
  801258:	e8 67 ef ff ff       	call   8001c4 <sys_page_alloc>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801291:	e8 ce ee ff ff       	call   800164 <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  801305:	e8 9e ed ff ff       	call   8000a8 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80136e:	e8 35 ed ff ff       	call   8000a8 <sys_cputs>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801d9e:	e8 8a e6 ff ff       	call   80042d <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801e18:	e8 dc e5 ff ff       	call   8003f9 <sys_ipc_try_send>
    	if(err == -E_IPC_NOT_RECV){
  801e1d:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801e20:	75 07                	jne    801e29 <ipc_send+0x57>
           sys_yield();
  801e22:	e8 6d e3 ff ff       	call   800194 <sys_yield>
          return ;
        }
		else{
			panic("ipc_send\n");
